...
@interface NSData (HXHash)

/**
 MD2 NSData
 */
@property (readonly) NSData *hx_MD2Data;

/**
 MD2 NSString
 */
@property (readonly) NSString *hx_MD2String;

/**
 MD4 NSData
 */
@property (readonly) NSData *hx_MD4Data;

/**
 MD4 NSString
 */
@property (readonly) NSString *hx_MD4String;

/**
 MD5 NSData
 */
@property (readonly) NSData *hx_MD5Data;

/**
 MD5 NSString
 */
@property (readonly) NSString *hx_MD5String;

/**
 SHA1 NSData
 */
@property (readonly) NSData *hx_SHA1Data;

/**
 SHA1 NSString
 */
@property (readonly) NSString *hx_SHA1String;

/**
 SHA224 NSData
 */
@property (readonly) NSData *hx_SHA224Data;

/**
 SHA224 NSString
 */
@property (readonly) NSString *hx_SHA224String;

/**
 SHA256 NSData
 */
@property (readonly) NSData *hx_SHA256Data;

/**
 SHA256 NSString
 */
@property (readonly) NSString *hx_SHA256String;

/**
 SHA384 NSData
 */
@property (readonly) NSData *hx_SHA384Data;

/**
 SHA384 NSString
 */
@property (readonly) NSString *hx_SHA384String;

/**
 SHA512 NSData
 */
@property (readonly) NSData *hx_SHA512Data;

/**
 SHA512 NSString
 */
@property (readonly) NSString *hx_SHA512String;
