...
CGContextRef _Nullable HXCGContextCreateARGBBitmapContext(CGSize size, BOOL opaque, CGFloat scale);

/// Create a `DeviceGray` Bitmap context. Returns NULL if an error occurs.
CGContextRef _Nullable HXCGContextCreateGrayBitmapContext(CGSize size, CGFloat scale);



/// Get main screen's scale.
CGFloat HXScreenScale(void);

/// Get main screen's size. Height is always larger than width.
CGSize HXScreenSize(void);
 ...
 */
CGAffineTransform HXCGAffineTransformGetFromPoints(CGPoint before[_Nullable 3], CGPoint after[_Nullable 3]);
...
UIViewContentMode HXCAGravityToUIViewContentMode(NSString *gravity);

/// Convert UIViewContentMode to CALayer's gravity string.
NSString *HXUIViewContentModeToCAGravity(UIViewContentMode contentMode);

/// Returns a rectangle to fit the "rect“ with specified content mode.
/// @param rect The constrant rect
/// @param size The content size
/// @param mode The content mode
CGRect HXCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode);
#endif
...
// main screen's scale
#ifndef kScreenScale
#define kScreenScale HXScreenScale()
#endif

// main screen's size (portrait)
#ifndef kScreenSize
#define kScreenSize HXScreenSize()
#endif

// main screen's width (portrait)
#ifndef kScreenWidth
#define kScreenWidth HXScreenSize().width
#endif

// main screen's height (portrait)
#ifndef kScreenHeight
#define kScreenHeight HXScreenSize().height
#endif
